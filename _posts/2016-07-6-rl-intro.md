...
But the fact is that <span class="highlight">**(real) environments are not controllable** and robots</span> nowadays pay the bill (someone that has ever produced robot demonstrations should know what i mean).
